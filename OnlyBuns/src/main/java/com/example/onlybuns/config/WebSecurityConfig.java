...
import com.example.onlybuns.service.impl.CustomUserDetailsService;
...
public class WebSecurityConfig {
    ...
    public WebSecurityCustomizer webSecurityCustomizer() {
        ...
        return (web) -> web.ignoring().antMatchers(HttpMethod.POST, "/auth/login","/location/create","/auth/signup")


                // Ovim smo dozvolili pristup statickim resursima aplikacije
                .antMatchers(HttpMethod.GET, "/", "/webjars/**", "/*.html", "favicon.ico",
                        "/**/*.html", "/**/*.css", "/**/*.js")
                .antMatchers(HttpMethod.GET, "/", "location/all", "user/userInfo")
                .antMatchers(HttpMethod.PUT, "/auth/activate/*");
